...
export function Input(props: React.HTMLProps<HTMLInputElement>) {
  const inputClass = `focus:ring-blue-600 py-3 focus:border-blue-500 block w-full pl-7 text-md border border-slate-500 rounded-md bg-transparent text-black     ${
